			...
			<div class="panel-body">
				<form class="bs-example form-horizontal" action="" method="post">
					...
					<div class="form-group text-right">
						<div class="col-lg-12"> 
							<button type="submit" class="btn btn-sm btn-success"><i class="fa fa-refresh icon"></i> Actualizar</button>
		...
		<section class="panel panel-default">
			<header class="panel-heading bg-light">
				<ul class="nav nav-tabs nav-justified">
					<li class="active"><a href="#home" data-toggle="tab">Observaciones</a></li>
					<li><a href="#profile" data-toggle="tab">Privado</a></li>
				</ul>
			</header>
			<div class="panel-body">
				<div class="tab-content">
					<div class="tab-pane active" id="home">
						<form action="" method="post">
							<textarea class="form-control" name="observaciones" style="height:400px;"></textarea>
							<div class="line line-dashed line-lg pull-in"></div>
							<div class="form-group text-right">
								<div class="col-lg-12"> 
									<button type="submit" class="btn btn-sm btn-success"><i class="fa fa-refresh icon"></i> Actualizar</button>
...
<?php
					if ( isset($_POST['privado']) ){
						$privado = mysql_real_escape_string($_POST['privado']);

						mysql_query("UPDATE clientes SET privado='".$privado."' WHERE id='".$id."'") or die(mysql_error());

					}
?>
						<form action="" method="post">
							<textarea class="form-control" name="privado" style="height:400px;"><?php echo $data->privado; ?></textarea>
							<div class="line line-dashed line-lg pull-in"></div>
							<div class="form-group text-right">
								<div class="col-lg-12"> 
									<button type="submit" class="btn btn-sm btn-success"><i class="fa fa-refresh icon"></i> Actualizar</button>
