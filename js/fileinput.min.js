...
(function(e) {
    ...
    var i = '<div class="form-control file-caption {class}">\n' +
        '   <span class="fa fa-folder-open-o"></span> <span class="file-caption-name"></span>\n' +
        "</div>";
    ...
    var a = function(e, t) {
        return typeof e !== "undefined" ? e.match("image.*") : t.match(
            /\.(gif|png|jpe?g)$/i)
    };
    var f = function(e, t) {
        return typeof e !== "undefined" ? e.match("text.*") : t.match(
            /\.(txt|md|csv|htm|html|php|ini)$/i)
    };
    var l = function() {
    ...
    var c = function(r, i) {
        ...
        this.isDisabled = this.$element.attr("disabled") || this.$element
            .attr("readonly");
        if (o(this.$element.attr("id"))) {
            this.$element.attr("id", l())
        }
        this.$container = this.createContainer();
        this.$captionContainer = u(i, "elCaptionContainer", this.$container
            .find(".file-caption"));
        this.$caption = u(i, "elCaptionText", this.$container.find(
            ".file-caption-name"));
        this.$previewContainer = u(i, "elPreviewContainer", this.$container
            .find(".file-preview"));
        this.$preview = u(i, "elPreviewImage", this.$container.find(
            ".file-preview-thumbnails"));
        this.$previewStatus = u(i, "elPreviewStatus", this.$container.find(
            ".file-preview-status"));
        this.$name = this.$element.attr("name") || i.name;
        this.$hidden = this.$container.find('input[type=hidden][name="' +
            this.$name + '"]');
    ...
    c.prototype = {
        ...
        listen: function() {
            ...
            t.$container.find(".fileinput-remove").on("click", e.proxy(
                t.clear, t))
        },
        trigger: function(e) {
            var t = this;
        ...
        clear: function(e) {
            ...
            t.$preview.html("");
            t.$caption.html("");
            t.$container.removeClass("file-input-new").addClass(
                "file-input-new")
        },
        reset: function(e) {
            var t = this;
        ...
        change: function(e) {
            ...
            for (var E = 0; E < w; E++) {
                (function(e) {
                    ...
                    if (u.length > 0 && (g == "any" ? n || r :
                            g == "text" ? r : n) && typeof FileReader !==
                        "undefined") {
                        ...
                        i.onload = function(e) {
                            ...
                            if (r) {
                                ...
                                n =
                                    '<div class="file-preview-frame"><div class="file-preview-text" title="' +
                                    t + '">' + o +
                                    "</div></div>" + i
                            } else {
                                n =
                                    '<div class="file-preview-frame"><img src="' +
                                    e.target.result +
                                    '" class="file-preview-image" title="' +
                                    t + '" alt="' + t +
                                    '"></div>'
                            }
                            u.append("\n" + n);
        ...
        renderMain: function() {
            ...
            var n = e.isDisabled ? e.captionClass +
                " file-caption-disabled" : e.captionClass;
            var r = e.captionTemplate.replace("{class}", n);
            return e.mainTemplate.replace("{class}", e.mainClass).replace(
                "{preview}", t).replace("{caption}", r).replace(
                "{remove}", e.renderRemove()).replace(
                "{browse}", e.renderBrowse())
        },
        renderBrowse: function() {
            ...
            return '<div class="' + t + '"' + n + "> " + e.browseIcon +
                e.browseLabel + " </div>"
        },
        renderRemove: function() {
            ...
            return '<button type="button" class="' + t + '"' + n +
                ">" + e.removeIcon + e.removeLabel + "</button>"
        },
    ...
    e.fn.fileinput = function(t) {
        ...
        return this.each(function() {
            var r = e(this),
                ...
                s = typeof t === "object" && t;
            if (!i) {
                r.data("fileinput", i = new c(this, e.extend({},
                    e.fn.fileinput.defaults, s, e(
                        this).data())))
            }
            if (typeof t === "string") {
                i[t].apply(i, n)
