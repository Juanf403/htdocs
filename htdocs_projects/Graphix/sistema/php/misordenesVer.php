		...
		<section class="panel panel-default">
			<header class="panel-heading">
				<div class="pull-right">
					<a href="admin.php?m=misordenes" class="return"><i class="fa fa-mail-reply"></i> Regresar </a>
				</div>
...
<?php
						if ( $data->estado == "0" ){
							echo '<a href="admin.php?m=misordenes&id='.$data->idorden.'&final=1" class="btn btn-sm btn-success pull-left"><i class="fa fa-check icon"></i> Finalizado</a>';
						} else {
							echo '<a href="admin.php?m=misordenes&id='.$data->idorden.'&final=0" class="btn btn-sm btn-warning pull-left"><i class="fa fa-clock-o icon"></i> Pendiente</a>';
						}
?>
							<a href="admin.php?m=misordenes" class="btn btn-sm btn-default"><i class="fa fa-reply icon"></i> Regresar</a>
						</div>
					</div>
				</form>
			</div>
