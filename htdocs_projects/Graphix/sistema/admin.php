...
if ( isset($_GET['m']) ){
	switch($_GET['m']) {
		...
		/* asignar */ 
		case "asignar":
			$paginaPHP = "php/asignar.php";
		break;
		case "asignarVer":
			$paginaPHP = "php/asignarVer.php";
		break;

		/* mis ordenes */
		case "misordenes":
			if ( !isset($_GET['id']) )
				$paginaPHP = "php/misordenes.php";
			else
				$paginaPHP = "php/misordenesVer.php";
		break;
...
?>
				<li><a class="btn btn-link" href="admin.php?m=ordenes"> <i class="fa fa-file-o"></i> </a></li>
				<li><a class="btn btn-link" href="admin.php?m=clientes"> <i class="fa fa-smile-o"></i> </a></li>
				<li><a class="btn btn-link" href="admin.php?m=asignar"> <i class="fa fa-male"></i> </a></li>
