...
<!DOCTYPE html>
<html lang="en" class="bg-blue js no-touch no-android chrome no-firefox no-iemobile no-ie no-ie10 no-ie11 no-ios no-ios7 ipad">
<head> 
		<meta charset="utf-8" />
		<title>Anglo Español| Sistema</title>
		...
		<div class="container aside-xxl">
			<section class="panel panel-default bg-white m-t-lg">
				<header class="panel-heading text-center">
					<h1 class="text-dark"><img src="images/anglo_login.png" alt=""></h1>
				</header>
