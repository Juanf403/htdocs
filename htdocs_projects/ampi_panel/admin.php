	...
	<section class="vbox">
		<header class="bg-black dk header navbar navbar-fixed-top-xs">
			<div class="navbar-header aside-md">
				...
				<a href="#" class="navbar-brand" data-toggle="fullscreen">AMPI</a>
									...
									<ul class="nav">
										...
										<li class="">
											...
											<ul class="nav lt" style="display: none;">
												<li> <a href="admin.php?m=mis"> <i class="fa fa-angle-right"></i> <span>Mis</span> </a> </li>
												<li> <a href="admin.php?m=otras"> <i class="fa fa-angle-right"></i> <span>Otras</span> </a> </li>
											</ul>
										</li>
