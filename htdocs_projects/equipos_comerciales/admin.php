...
if ( isset($_GET['m']) ){
	switch($_GET['m']) {
		...
		break;
		case "archivo":
			$paginaPHP = "php/archivo.php";
		break;
		case "facturas":
			$paginaPHP = "php/facturas.php";
		break;
		case "facturasAgregar":
			$paginaPHP = "php/facturasAgregar.php";
		break;
...
<title>Equipos Comerciales |</title>
							...
							<div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
								...
								<nav class="nav-primary hidden-xs">
									<ul class="nav">
										...
										<li> <a href="admin.php?m=facturas"> <i class="fa fa-angle-right"></i> <span>Facturas</span> </a> </li>
										<li class="">
