...
if ( isset($_POST['nombre']) ){
	...
	if ( mysql_query("UPDATE clientes SET nombre='".$nombre."',direccion='".$direccion."',telefono='".$telefono."',numcliente='".$numcliente."',email='".$correo."',rfc='".$rfc."' WHERE id='".$id."'") ){
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-lg-10"><input type="text" name="numcliente" value="<?php echo $data->numcliente; ?>" class="form-control" placeholder="#"></div>
					</div>
				</div>
			</div>
			<div class="row">
