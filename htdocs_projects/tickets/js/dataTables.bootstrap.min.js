...
(function(b) {
    ...
    d.ext.renderer.pageButton.bootstrap = function(a, h, r, m, j, n) {
        var o = new d.Api(a),
            ...
            q = function(d, e) {
                var l, h, i, c, m = function(a) {
                    a.preventDefault();
                    !b(a.currentTarget).hasClass("disabled") && o.page() !=
                        a.data.action && o.page(a.data.action).draw(
                            "page")
                };
                l = 0;
                for (h = e.length; l < h; l++)
                    if (c = e[l], b.isArray(c)) q(d, c);
                        ...
                        }).html(f)).appendTo(d), a.oApi._fnBindAction(
                            i, {
                                action: c
                            }, m), p++)
                    }
        ...
        q(b(h).empty().html('<ul class="pagination"/>').children("ul"),
            m);
