...
if ( isset($_POST['user']) ){
	...
	$consulta = "SELECT * FROM user WHERE userName='".$user."' AND password='".$pass."' LIMIT 1";
	if ( mysql_num_rows( mysql_query($consulta) )){
		...
		//mysql_query("UPDATE user SET acceso='".date("Y/m/d")."' WHERE id='".$data->id."'");
...
<head> 
		...
		<link rel="stylesheet" type="text/css" href="css/app.v1.css">
		<!--[if lt IE 9]>
